...
export const COUNTRY_PHOTOS: Record<string, CountryPhoto> = {
  ...
  NL: { url: 'https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=1200&q=80&auto=format&fit=crop', fallbackFrom: '#065f46', fallbackTo: '#047857' },
  HR: { url: 'https://images.unsplash.com/photo-1555990793-da11153b2473?w=1200&q=80&auto=format&fit=crop', fallbackFrom: '#78350f', fallbackTo: '#b45309' },
  ...
  EG: { url: 'https://images.unsplash.com/photo-1553913861-c0fddf2619ee?w=1200&q=80&auto=format&fit=crop', fallbackFrom: '#78350f', fallbackTo: '#a16207' },
